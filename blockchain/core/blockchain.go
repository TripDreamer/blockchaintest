...
func (bl *Blockchain) CreateNewBlock() Block { //The previous block hash

	prevBlock := bl.BlockSlice.PreviousBlock() //qian yi ge qu kuai
	prevBlockHash := []byte{}
	if prevBlock != nil {
	...
	b := NewBlock(prevBlockHash) //return Header of NewBlock
